...
function gen(cookie, elem) {
    const options = {
        method: 'POST',
        headers: {
          cookie: '_ym_uid=1705508036168852481; _ym_d=1706113600; _ym_isad=2; _ym_visorc=w',
          authority: 'www.helpfront.ru',
          accept: '*/*',
          'accept-language': 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7',
          'content-type': 'application/json',
          origin: 'https://www.helpfront.ru',
          referer: 'https://www.helpfront.ru/account/profile',
          'sec-ch-ua': '^\^Not',
          'sec-ch-ua-mobile': '?0',
        ...
        body: `{"ach":"${elem}","_id":"${cookie}","isLocal":false}`
      };
      
      fetch('https://www.helpfront.ru/api/getAchievement', options)
